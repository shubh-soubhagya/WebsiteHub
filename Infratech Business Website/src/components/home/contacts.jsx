    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="content">
          <h2 className="title">Start Your Next Project With Us.</h2>
          <p className="description">
              Ready to build something amazing? Reach out today and let's turn your vision into a concrete reality.          </p>
          <div className="buttons">
            <a href="/contact" className="button primary">
              Contact Us <ArrowRight size={16} />
            </a>
            <a href="/projects" className="button secondary">
              See Our Work <BookOpen size={16} />
            </a>
          </div>
        </div>
      </div>
